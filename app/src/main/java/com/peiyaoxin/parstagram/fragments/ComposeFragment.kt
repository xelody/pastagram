    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "Photo file error")
                Toast.makeText(requireContext(), "Error happened in photoFile", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Error in saving", Toast.LENGTH_SHORT)
                    .show()
            } else {
